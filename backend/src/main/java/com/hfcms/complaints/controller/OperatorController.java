...
public class OperatorController {
    ...
    private Long resolveUserId(Long headerId) {
        ...
        return headerId != null ? headerId : 2L;
    }
    ...
    public ResponseEntity<ApiResponse<ComplaintResponse>> reviewComplaint(
        ...
        ComplaintResponse response = operatorService.reviewComplaint(id, request, resolvedOperatorId);
    ...
    public ResponseEntity<ApiResponse<Void>> decideRelatedCase(
        ...
        Long resolvedOperatorId = resolveUserId(operatorId);
        operatorService.decideRelatedCase(id, relatedId, request, resolvedOperatorId);
